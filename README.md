...
> 本仓库基于 [vLLM v0.21.0](https://github.com/vllm-project/vllm) 源码，旨在系统性地梳理和解读 vLLM 的架构设计与核心实现。
